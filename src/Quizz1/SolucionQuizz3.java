...
public class SolucionQuizz3 {
    public static void main(String[] args) {
        ...
        if(indIngrediente1==true && indIngrediente2==false && indIngrediente3==false){
            pagoTotal = precioIngrediente1;
        }
        else if(indIngrediente1==true && indIngrediente2==true && indIngrediente3==false){
            pagoTotal = precioIngrediente1 + precioIngrediente2;
        }
        else if(indIngrediente1==true && indIngrediente2==true && indIngrediente3==true){
            pagoTotal = precioIngrediente1 + precioIngrediente2 + precioIngrediente3;
        }
        else if(indIngrediente1==false && indIngrediente2==true && indIngrediente3==false){
            pagoTotal = precioIngrediente2;
        }
        else if(indIngrediente1==false && indIngrediente2==false && indIngrediente3==true){
            pagoTotal = precioIngrediente1 + precioIngrediente2;
        }
        else if(indIngrediente1==false && indIngrediente2==true && indIngrediente3==true){
            pagoTotal = precioIngrediente2 + precioIngrediente3;
        }
        else if(indIngrediente1==true && indIngrediente2==false && indIngrediente3==true){
            pagoTotal = precioIngrediente1 + precioIngrediente3;
        }
        else if(indIngrediente1==false && indIngrediente2==false && indIngrediente3==true){
            pagoTotal = precioIngrediente3;
        }
